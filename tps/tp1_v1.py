...
if (len(patente) == 7):
    if ((patente[0].isnumeric() != True) and (patente[1].isnumeric() != True)):
        if (patente[2].isnumeric()):
            if ((patente[3].isnumeric()) and (patente[4].isnumeric())):
                if ((patente[5].isnumeric() != True) and (patente[6].isnumeric() != True)):
            ...
            if (patente[3].isnumeric() and patente[5].isnumeric() and patente[6].isnumeric()):
                if (patente[4].isnumeric()):
                    patente_pais = paises[4]
                else:
                    patente_pais = paises[2]
            elif (patente[3].isnumeric() != True and patente[4].isnumeric() and patente[5].isnumeric() and patente[6].isnumeric()):
